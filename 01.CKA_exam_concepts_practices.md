...
- **Kubernetes Cluster Installation**
    1. Cluster Node Requirement
        ...
        - Install without using swap space (comment out swap on /etc/fstab and reboot the machine)
...
```
     $kubectl get pods -o wideâ€?--show-labelsâ€?--all-namespaces
```
...
#putihfj
192.168.11.5    putihfj
192.168.11.18   kb-master.example.com
192.168.11.17   kb-worker1.example.com
192.168.11.20   kb-worker2.example.com
